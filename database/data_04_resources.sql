...
-- Bài 1 
(@bh_sp_1_1, 'Read a Text Aloud 1 (Video)', 'Video', '300MB', 'Giới thiệu về trọng âm từ, trọng âm câu và ngữ điệu cơ bản để đọc tự nhiên.', 'video/mp4', 'public',
...
(@bh_sp_1_1, 'Read a Text Aloud 1 (PDF)',   'PDF',   '10MB',  'Giới thiệu về trọng âm từ, trọng âm câu và ngữ điệu cơ bản để đọc tự nhiên.', 'application/pdf', 'public',
...
-- Bài 2
(@bh_sp_1_2, 'Read a Text Aloud 2 (Video)', 'Video', '300MB', 'Thực hành các mẫu câu phổ biến để làm quen với ngữ điệu lên và xuống trong tiếng Anh.', 'video/mp4', 'public',
...
(@bh_sp_1_2, 'Read a Text Aloud 2 (PDF)',   'PDF',   '10MB',  'Thực hành các mẫu câu phổ biến để làm quen với ngữ điệu lên và xuống trong tiếng Anh.', 'application/pdf', 'public',
...
-- Bài 3
(@bh_sp_1_3, 'Read a Text Aloud 3 (Video)', 'Video', '300MB', 'Giải đáp các thắc mắc thường gặp và mẹo thực hành để cải thiện kỹ năng đọc thành tiếng.', 'video/mp4', 'public',
...
(@bh_sp_1_3, 'Read a Text Aloud 3 (PDF)',   'PDF',   '10MB',  'Giải đáp các thắc mắc thường gặp và mẹo thực hành để cải thiện kỹ năng đọc thành tiếng.', 'application/pdf', 'public',
...
-- Bài 1
(@bh_sp_2_1, 'Describe a Picture 1 (Video)', 'Video', '350MB', 'Chiến lược quản lý thời gian và xây dựng cấu trúc câu cơ bản để miêu tả một bức ảnh.', 'video/mp4', 'public',
...
(@bh_sp_2_1, 'Describe a Picture 1 (PDF)',   'PDF',   '10MB',  'Chiến lược quản lý thời gian và xây dựng cấu trúc câu cơ bản để miêu tả một bức ảnh.', 'application/pdf', 'public',
...
-- Bài 2
(@bh_sp_2_2, 'Describe a Picture 2 (Video)', 'Video', '350MB', 'Hướng dẫn cách thêm các chi tiết về vị trí, hành động, và đối tượng để bài miêu tả sinh động hơn.', 'video/mp4', 'public',
...
(@bh_sp_2_2, 'Describe a Picture 2 (PDF)',   'PDF',   '10MB',  'Hướng dẫn cách thêm các chi tiết về vị trí, hành động, và đối tượng để bài miêu tả sinh động hơn.', 'application/pdf', 'public',
...
-- Bài 3
(@bh_sp_2_3, 'Describe a Picture 3 (Video)', 'Video', '350MB', 'Thực hành với các bài tập mô phỏng phần Đọc và Miêu tả ảnh để làm quen với áp lực phòng thi.', 'video/mp4', 'public',
...
(@bh_sp_2_3, 'Describe a Picture 3 (PDF)',   'PDF',   '10MB',  'Thực hành với các bài tập mô phỏng phần Đọc và Miêu tả ảnh để làm quen với áp lực phòng thi.', 'application/pdf', 'public',
...
-- Bài 1
(@bh_sp_3_1, 'Respond to Questions 1 (Video)', 'Video', '250MB', 'Phân tích các dạng câu hỏi thường gặp và phương pháp trả lời ngắn gọn, đúng trọng tâm.', 'video/mp4', 'public',
...
(@bh_sp_3_1, 'Respond to Questions 1 (PDF)',   'PDF',   '10MB',  'Phân tích các dạng câu hỏi thường gặp và phương pháp trả lời ngắn gọn, đúng trọng tâm.', 'application/pdf', 'public',
...
-- Bài 2
(@bh_sp_3_2, 'Respond to Questions 2 (Video)', 'Video', '250MB', 'Thực hành trả lời các câu hỏi về chủ đề quen thuộc như công việc, sở thích và hoạt động hàng ngày.', 'video/mp4', 'public',
...
(@bh_sp_3_2, 'Respond to Questions 2 (PDF)',   'PDF',   '10MB',  'Thực hành trả lời các câu hỏi về chủ đề quen thuộc như công việc, sở thích và hoạt động hàng ngày.', 'application/pdf', 'public',
...
-- Bài 3
(@bh_sp_3_3, 'Respond to Questions 3 (Video)', 'Video', '250MB', 'Luyện tập với các câu hỏi mô phỏng, tập trung cải thiện tốc độ và sự trôi chảy.', 'video/mp4', 'public',
...
(@bh_sp_3_3, 'Respond to Questions 3 (PDF)',   'PDF',   '10MB',  'Luyện tập với các câu hỏi mô phỏng, tập trung cải thiện tốc độ và sự trôi chảy.', 'application/pdf', 'public',
...
-- Bài 1
(@bh_sp_4_1, 'Respond to Questions Using Information 1 (Video)', 'Video', '350MB', 'Hướng dẫn cách đọc và phân tích nhanh các loại tài liệu cho sẵn như lịch trình, biểu đồ.', 'video/mp4', 'public',
...
(@bh_sp_4_1, 'Respond to Questions Using Information 1 (PDF)',   'PDF',   '10MB',  'Hướng dẫn cách đọc và phân tích nhanh các loại tài liệu cho sẵn như lịch trình, biểu đồ.', 'application/pdf', 'public',
...
-- Bài 2
(@bh_sp_4_2, 'Respond to Questions Using Information 2 (Video)', 'Video', '350MB', 'Thực hành kỹ năng tìm kiếm và tổng hợp thông tin từ tài liệu để trả lời câu hỏi.', 'video/mp4', 'public',
...
(@bh_sp_4_2, 'Respond to Questions Using Information 2 (PDF)',   'PDF',   '10MB',  'Thực hành kỹ năng tìm kiếm và tổng hợp thông tin từ tài liệu để trả lời câu hỏi.', 'application/pdf', 'public',
...
-- Bài 3
(@bh_sp_4_3, 'Respond to Questions Using Information 3 (Video)', 'Video', '350MB', 'Áp dụng kỹ năng vào các bài tập mô phỏng với nhiều dạng tài liệu và câu hỏi phức tạp.', 'video/mp4', 'public',
...
(@bh_sp_4_3, 'Respond to Questions Using Information 3 (PDF)',   'PDF',   '10MB',  'Áp dụng kỹ năng vào các bài tập mô phỏng với nhiều dạng tài liệu và câu hỏi phức tạp.', 'application/pdf', 'public',
...
INSERT INTO TAILIEUHOCTAP
(maBH, tenTL, loai, kichThuoc, moTa, mime_type, visibility, public_url) VALUES
-- Chương 1 - Express an Opinion
-- Bài 1
(@bh_wr_1_1, 'Express an Opinion 1 (Video)', 'Video', '450MB', 'Xây dựng cấu trúc cho một bài trình bày quan điểm: Mở đầu, luận điểm, và kết luận.', 'video/mp4', 'public',
...
(@bh_wr_1_1, 'Express an Opinion 1 (PDF)',   'PDF',   '10MB',  'Xây dựng cấu trúc cho một bài trình bày quan điểm: Mở đầu, luận điểm, và kết luận.', 'application/pdf', 'public',
...
-- Bài 2
(@bh_wr_1_2, 'Express an Opinion 2 (Video)', 'Video', '450MB', 'Cách sử dụng các cụm từ nối và từ vựng để thể hiện quan điểm một cách thuyết phục.', 'video/mp4', 'public',
...
(@bh_wr_1_2, 'Express an Opinion 2 (PDF)',   'PDF',   '10MB',  'Cách sử dụng các cụm từ nối và từ vựng để thể hiện quan điểm một cách thuyết phục.', 'application/pdf', 'public',
...
-- Bài 3
(@bh_wr_1_3, 'Express an Opinion 3 (Video)', 'Video', '450MB', 'Thực hành trình bày quan điểm về các chủ đề xã hội và công việc thường gặp.', 'video/mp4', 'public',
...
(@bh_wr_1_3, 'Express an Opinion 3 (PDF)',   'PDF',   '10MB',  'Thực hành trình bày quan điểm về các chủ đề xã hội và công việc thường gặp.', 'application/pdf', 'public',
...
-- Chương 2 - Write a Sentence Based on a Picture
-- Bài 1
(@bh_wr_2_1, 'Write a Sentence Based on a Picture 1 (Video)', 'Video', '500MB', 'Các cấu trúc ngữ pháp và từ vựng cần thiết để viết một câu miêu tả ảnh chính xác.', 'video/mp4', 'public',
...
(@bh_wr_2_1, 'Write a Sentence Based on a Picture 1 (PDF)',   'PDF',   '10MB',  'Các cấu trúc ngữ pháp và từ vựng cần thiết để viết một câu miêu tả ảnh chính xác.', 'application/pdf', 'public',
...
-- Bài 2
(@bh_wr_2_2, 'Write a Sentence Based on a Picture 2 (Video)', 'Video', '300MB', 'Luyện tập viết câu tập trung vào việc sử dụng đúng giới từ, thì và dạng của từ.', 'video/mp4', 'public',
...
(@bh_wr_2_2, 'Write a Sentence Based on a Picture 2 (PDF)',   'PDF',   '10MB',  'Luyện tập viết câu tập trung vào việc sử dụng đúng giới từ, thì và dạng của từ.', 'application/pdf', 'public',
...
-- Bài 3
(@bh_wr_2_3, 'Write a Sentence Based on a Picture 3 (Video)', 'Video', '300MB', 'Phân tích các lỗi sai thường gặp khi viết câu miêu tả ảnh và cách khắc phục.', 'video/mp4', 'public',
...
(@bh_wr_2_3, 'Write a Sentence Based on a Picture 3 (PDF)',   'PDF',   '10MB',  'Phân tích các lỗi sai thường gặp khi viết câu miêu tả ảnh và cách khắc phục.', 'application/pdf', 'public',
...
-- Chương 3 - Respond to Written Resquest
-- Bài 1
(@bh_wr_3_1, 'Respond to Written Resquest 1 (Video)', 'Video', '250MB', 'Tìm hiểu cấu trúc chuẩn của một email công việc: Chào hỏi, nội dung chính, và kết thúc.', 'video/mp4', 'public',
...
(@bh_wr_3_1, 'Respond to Written Resquest 1 (PDF)',   'PDF',   '10MB',  'Tìm hiểu cấu trúc chuẩn của một email công việc: Chào hỏi, nội dung chính, và kết thúc.', 'application/pdf', 'public',
...
-- Bài 2
(@bh_wr_3_2, 'Respond to Written Resquest 2 (Video)', 'Video', '300MB', 'Phân tích các yêu cầu thường gặp và cách trả lời email một cách lịch sự, chuyên nghiệp.', 'video/mp4', 'public',
...
(@bh_wr_3_2, 'Respond to Written Resquest 2 (PDF)',   'PDF',   '10MB',  'Phân tích các yêu cầu thường gặp và cách trả lời email một cách lịch sự, chuyên nghiệp.', 'application/pdf', 'public',
...
-- Bài 3
(@bh_wr_3_3, 'Respond to Written Resquest 3 (Video)', 'Video', '300MB', 'Thực hành viết email phản hồi cho các tình huống công việc cụ thể.', 'video/mp4', 'public',
...
(@bh_wr_3_3, 'Respond to Written Resquest 3 (PDF)',   'PDF',   '10MB',  'Thực hành viết email phản hồi cho các tình huống công việc cụ thể.', 'application/pdf', 'public',
...
-- Chương 4 - Write an Opinion Essay
-- Bài 1
(@bh_wr_4_1, 'Write an Opinion Essay 1 (Video)', 'Video', '350MB', 'Hướng dẫn cách lên dàn ý chi tiết cho một bài luận trình bày quan điểm.', 'video/mp4', 'public',
...
(@bh_wr_4_1, 'Write an Opinion Essay 1 (PDF)',   'PDF',   '10MB',  'Hướng dẫn cách lên dàn ý chi tiết cho một bài luận trình bày quan điểm.', 'application/pdf', 'public',
...
-- Bài 2
(@bh_wr_4_2, 'Write an Opinion Essay 2 (Video)', 'Video', '350MB', 'Phát triển luận điểm, đưa ra ví dụ và dẫn chứng để bài viết có sức thuyết phục.', 'video/mp4', 'public',
...
(@bh_wr_4_2, 'Write an Opinion Essay 2 (PDF)',   'PDF',   '10MB',  'Phát triển luận điểm, đưa ra ví dụ và dẫn chứng để bài viết có sức thuyết phục.', 'application/pdf', 'public',
...
-- Bài 3
(@bh_wr_4_3, 'Write an Opinion Essay 3 (Video)', 'Video', '350MB', 'Thực hành viết một bài luận hoàn chỉnh và các tiêu chí tự đánh giá.', 'video/mp4', 'public',
...
(@bh_wr_4_3, 'Write an Opinion Essay 3 (PDF)',   'PDF',   '10MB',  'Thực hành viết một bài luận hoàn chỉnh và các tiêu chí tự đánh giá.', 'application/pdf', 'public',
...
-- Bài 1
(@bh_li_1_1, 'Photographs Video Bài 1', 'Video', '350MB', 'Chiến lược làm bài thi Nghe tổng quan và các mẹo để tập trung tối đa.', 'video/mp4', 'public', 
...
(@bh_li_1_1, 'Photographs PDF Bài 1.1',   'PDF',   '10MB', 'Chiến lược làm bài thi Nghe tổng quan và các mẹo để tập trung tối đa.', 'application/pdf', 'public', 
...
(@bh_li_1_1, 'Photographs PDF Bài 1.2',   'PDF',   '10MB', 'Chiến lược làm bài thi Nghe tổng quan và các mẹo để tập trung tối đa.', 'application/pdf', 'public', 
...
(@bh_li_1_1, 'Photographs Audio 1 Bài 1','Audio', '20MB', 'Chiến lược làm bài thi Nghe tổng quan và các mẹo để tập trung tối đa.', 'audio/mpeg', 'public', 
...
(@bh_li_1_1, 'Photographs Audio 2 Bài 1','Audio', '20MB', 'Chiến lược làm bài thi Nghe tổng quan và các mẹo để tập trung tối đa.', 'audio/mpeg', 'public', 
...
(@bh_li_1_1, 'Photographs Audio 3 Bài 1','Audio', '20MB', 'Chiến lược làm bài thi Nghe tổng quan và các mẹo để tập trung tối đa.', 'audio/mpeg', 'public', 
...
-- Bài 2
(@bh_li_1_2, 'Photographs Video Bài 2', 'Video', '350MB', 'Phân tích các loại bẫy thường gặp trong Part 1 (từ đồng âm, mô tả sai đối tượng).', 'video/mp4', 'public', 
...
(@bh_li_1_2, 'Photographs PDF Bài 2',   'PDF',   '10MB', 'Phân tích các loại bẫy thường gặp trong Part 1 (từ đồng âm, mô tả sai đối tượng).', 'application/pdf', 'public', 
...
(@bh_li_1_2, 'Photographs Audio 1 Bài 2','Audio', '20MB', 'Phân tích các loại bẫy thường gặp trong Part 1 (từ đồng âm, mô tả sai đối tượng).', 'audio/mpeg', 'public', 
...
(@bh_li_1_2, 'Photographs Audio 2 Bài 2','Audio', '20MB', 'Phân tích các loại bẫy thường gặp trong Part 1 (từ đồng âm, mô tả sai đối tượng).', 'audio/mpeg', 'public', 
...
(@bh_li_1_2, 'Photographs Audio 3 Bài 2','Audio', '20MB', 'Phân tích các loại bẫy thường gặp trong Part 1 (từ đồng âm, mô tả sai đối tượng).', 'audio/mpeg', 'public', 
...
-- Bài 3
(@bh_li_1_3, 'Photographs Video Bài 3', 'Video', '350MB', 'Luyện nghe với các hình ảnh đa dạng về người, vật và phong cảnh.', 'video/mp4', 'public', 
...
(@bh_li_1_3, 'Photographs PDF Bài 3.1',   'PDF',   '10MB', 'Luyện nghe với các hình ảnh đa dạng về người, vật và phong cảnh.', 'application/pdf', 'public', 
...
(@bh_li_1_3, 'Photographs PDF Bài 3.2',   'PDF',   '10MB', 'Luyện nghe với các hình ảnh đa dạng về người, vật và phong cảnh.', 'application/pdf', 'public', 
...
(@bh_li_1_3, 'Photographs Audio 1 Bài 3','Audio', '20MB', 'Luyện nghe với các hình ảnh đa dạng về người, vật và phong cảnh.', 'audio/mpeg', 'public', 
...
(@bh_li_1_3, 'Photographs Audio 2 Bài 3','Audio', '20MB', 'Luyện nghe với các hình ảnh đa dạng về người, vật và phong cảnh.', 'audio/mpeg', 'public', 
...
(@bh_li_1_3, 'Photographs Audio 3 Bài 3','Audio', '20MB', 'Luyện nghe với các hình ảnh đa dạng về người, vật và phong cảnh.', 'audio/mpeg', 'public', 
...
-- Bài 1
(@bh_li_2_1, 'Question - Response Video Bài 1', 'Video', '350MB', 'Nhận diện các dạng câu hỏi (Who, What, Where, When, Why, How) và cách trả lời tương ứng.', 'video/mp4', 'public', 
...
(@bh_li_2_1, 'Question - Response PDF Bài 1',   'PDF',   '10MB', 'Nhận diện các dạng câu hỏi (Who, What, Where, When, Why, How) và cách trả lời tương ứng.', 'application/pdf', 'public', 
...
(@bh_li_2_1, 'Question - Response Audio 1 Bài 1','Audio', '20MB', 'Nhận diện các dạng câu hỏi (Who, What, Where, When, Why, How) và cách trả lời tương ứng.', 'audio/mpeg', 'public', 
...
(@bh_li_2_1, 'Question - Response Audio 2 Bài 1','Audio', '20MB', 'Nhận diện các dạng câu hỏi (Who, What, Where, When, Why, How) và cách trả lời tương ứng.', 'audio/mpeg', 'public', 
...
(@bh_li_2_1, 'Question - Response Audio 3 Bài 1','Audio', '20MB', 'Nhận diện các dạng câu hỏi (Who, What, Where, When, Why, How) và cách trả lời tương ứng.', 'audio/mpeg', 'public', 
...
-- Bài 2
(@bh_li_2_2, 'Question - Response Video Bài 2', 'Video', '350MB', 'Luyện tập nghe các câu hỏi và câu trả lời với nhiều giọng đọc khác nhau.', 'video/mp4', 'public', 
...
(@bh_li_2_2, 'Question - Response PDF Bài 2',   'PDF',   '10MB', 'Luyện tập nghe các câu hỏi và câu trả lời với nhiều giọng đọc khác nhau.', 'application/pdf', 'public', 
...
(@bh_li_2_2, 'Question - Response Audio 1 Bài 2','Audio', '20MB', 'Luyện tập nghe các câu hỏi và câu trả lời với nhiều giọng đọc khác nhau.', 'audio/mpeg', 'public', 
...
(@bh_li_2_2, 'Question - Response Audio 2 Bài 2','Audio', '20MB', 'Luyện tập nghe các câu hỏi và câu trả lời với nhiều giọng đọc khác nhau.', 'audio/mpeg', 'public', 
...
(@bh_li_2_2, 'Question - Response Audio 3 Bài 2','Audio', '20MB', 'Luyện tập nghe các câu hỏi và câu trả lời với nhiều giọng đọc khác nhau.', 'audio/mpeg', 'public', 
...
-- Bài 3
(@bh_li_2_3, 'Question - Response Video Bài 3', 'Video', '350MB', 'Phân tích các lựa chọn gây nhiễu và mẹo để chọn đáp án đúng một cách nhanh chóng.', 'video/mp4', 'public', 
...
(@bh_li_2_3, 'Question - Response PDF Bài 3',   'PDF',   '10MB', 'Phân tích các lựa chọn gây nhiễu và mẹo để chọn đáp án đúng một cách nhanh chóng.', 'application/pdf', 'public', 
...
(@bh_li_2_3, 'Question - Response Audio 1 Bài 3','Audio', '20MB', 'Phân tích các lựa chọn gây nhiễu và mẹo để chọn đáp án đúng một cách nhanh chóng.', 'audio/mpeg', 'public', 
...
(@bh_li_2_3, 'Question - Response Audio 2 Bài 3','Audio', '20MB', 'Phân tích các lựa chọn gây nhiễu và mẹo để chọn đáp án đúng một cách nhanh chóng.', 'audio/mpeg', 'public', 
...
(@bh_li_2_3, 'Question - Response Audio 3 Bài 3','Audio', '20MB', 'Phân tích các lựa chọn gây nhiễu và mẹo để chọn đáp án đúng một cách nhanh chóng.', 'audio/mpeg', 'public', 
...
-- Bài 1
(@bh_li_3_1, 'Short Conversations Video Bài 1', 'Video', '350MB', 'Kỹ năng đọc trước câu hỏi để định hướng thông tin cần nghe trong đoạn hội thoại.', 'video/mp4', 'public', 
...
(@bh_li_3_1, 'Short Conversations PDF Bài 1',   'PDF',   '10MB', 'Kỹ năng đọc trước câu hỏi để định hướng thông tin cần nghe trong đoạn hội thoại.', 'application/pdf', 'public', 
...
(@bh_li_3_1, 'Short Conversations Audio 1 Bài 1','Audio', '20MB', 'Kỹ năng đọc trước câu hỏi để định hướng thông tin cần nghe trong đoạn hội thoại.', 'audio/mpeg', 'public', 
...
(@bh_li_3_1, 'Short Conversations Audio 2 Bài 1','Audio', '20MB', 'Kỹ năng đọc trước câu hỏi để định hướng thông tin cần nghe trong đoạn hội thoại.', 'audio/mpeg', 'public', 
...
(@bh_li_3_1, 'Short Conversations Audio 3 Bài 1','Audio', '20MB', 'Kỹ năng đọc trước câu hỏi để định hướng thông tin cần nghe trong đoạn hội thoại.', 'audio/mpeg', 'public', 
...
-- Bài 2
(@bh_li_3_2, 'Short Conversations Video Bài 2', 'Video', '350MB', 'Luyện nghe các đoạn hội thoại về chủ đề công sở, mua sắm, và đời sống hàng ngày.', 'video/mp4', 'public', 
...
(@bh_li_3_2, 'Short Conversations PDF Bài 2',   'PDF',   '10MB', 'Luyện nghe các đoạn hội thoại về chủ đề công sở, mua sắm, và đời sống hàng ngày.', 'application/pdf', 'public', 
...
(@bh_li_3_2, 'Short Conversations Audio 1 Bài 2','Audio', '20MB', 'Luyện nghe các đoạn hội thoại về chủ đề công sở, mua sắm, và đời sống hàng ngày.', 'audio/mpeg', 'public', 
...
(@bh_li_3_2, 'Short Conversations Audio 2 Bài 2','Audio', '20MB', 'Luyện nghe các đoạn hội thoại về chủ đề công sở, mua sắm, và đời sống hàng ngày.', 'audio/mpeg', 'public', 
...
(@bh_li_3_2, 'Short Conversations Audio 3 Bài 2','Audio', '20MB', 'Luyện nghe các đoạn hội thoại về chủ đề công sở, mua sắm, và đời sống hàng ngày.', 'audio/mpeg', 'public', 
...
-- Bài 3
(@bh_li_3_3, 'Short Conversations Video Bài 3', 'Video', '350MB', 'Cách suy luận ý của người nói và mục đích của cuộc hội thoại.', 'video/mp4', 'public', 
...
(@bh_li_3_3, 'Short Conversations PDF Bài 3',   'PDF',   '10MB', 'Cách suy luận ý của người nói và mục đích của cuộc hội thoại.', 'application/pdf', 'public', 
...
(@bh_li_3_3, 'Short Conversations Audio 1 Bài 3','Audio', '20MB', 'Cách suy luận ý của người nói và mục đích của cuộc hội thoại.', 'audio/mpeg', 'public', 
...
(@bh_li_3_3, 'Short Conversations Audio 2 Bài 3','Audio', '20MB', 'Cách suy luận ý của người nói và mục đích của cuộc hội thoại.', 'audio/mpeg', 'public', 
...
(@bh_li_3_3, 'Short Conversations Audio 3 Bài 3','Audio', '20MB', 'Cách suy luận ý của người nói và mục đích của cuộc hội thoại.', 'audio/mpeg', 'public', 
...
-- Bài 1
(@bh_li_4_1, 'Short Talks Video Bài 1', 'Video', '350MB', 'Nhận diện các dạng bài nói ngắn: tin nhắn thoại, thông báo, quảng cáo, báo cáo.', 'video/mp4', 'public', 
...
(@bh_li_4_1, 'Short Talks PDF Bài 1',   'PDF',   '10MB', 'Nhận diện các dạng bài nói ngắn: tin nhắn thoại, thông báo, quảng cáo, báo cáo.', 'application/pdf', 'public', 
...
(@bh_li_4_1, 'Short Talks Audio 1 Bài 1','Audio', '20MB', 'Nhận diện các dạng bài nói ngắn: tin nhắn thoại, thông báo, quảng cáo, báo cáo.', 'audio/mpeg', 'public', 
...
(@bh_li_4_1, 'Short Talks Audio 2 Bài 1','Audio', '20MB', 'Nhận diện các dạng bài nói ngắn: tin nhắn thoại, thông báo, quảng cáo, báo cáo.', 'audio/mpeg', 'public', 
...
(@bh_li_4_1, 'Short Talks Audio 3 Bài 1','Audio', '20MB', 'Nhận diện các dạng bài nói ngắn: tin nhắn thoại, thông báo, quảng cáo, báo cáo.', 'audio/mpeg', 'public', 
...
-- Bài 2
(@bh_li_4_2, 'Short Talks Video Bài 2', 'Video', '350MB', 'Luyện nghe và nắm bắt các thông tin chi tiết như số liệu, thời gian, địa điểm.', 'video/mp4', 'public', 
...
(@bh_li_4_2, 'Short Talks PDF Bài 2',   'PDF',   '10MB', 'Luyện nghe và nắm bắt các thông tin chi tiết như số liệu, thời gian, địa điểm.', 'application/pdf', 'public', 
...
(@bh_li_4_2, 'Short Talks Audio 1 Bài 2','Audio', '20MB', 'Luyện nghe và nắm bắt các thông tin chi tiết như số liệu, thời gian, địa điểm.', 'audio/mpeg', 'public', 
...
(@bh_li_4_2, 'Short Talks Audio 2 Bài 2','Audio', '20MB', 'Luyện nghe và nắm bắt các thông tin chi tiết như số liệu, thời gian, địa điểm.', 'audio/mpeg', 'public', 
...
(@bh_li_4_2, 'Short Talks Audio 3 Bài 2','Audio', '20MB', 'Luyện nghe và nắm bắt các thông tin chi tiết như số liệu, thời gian, địa điểm.', 'audio/mpeg', 'public', 
...
-- Bài 3
(@bh_li_4_3, 'Short Talks Video Bài 3', 'Video', '350MB', 'Thực hành với các bài nói có tốc độ nhanh và chứa nhiều thông tin.', 'video/mp4', 'public', 
...
(@bh_li_4_3, 'Short Talks PDF Bài 3',   'PDF',   '10MB', 'Thực hành với các bài nói có tốc độ nhanh và chứa nhiều thông tin.', 'application/pdf', 'public', 
...
(@bh_li_4_3, 'Short Talks Audio 1 Bài 3','Audio', '20MB', 'Thực hành với các bài nói có tốc độ nhanh và chứa nhiều thông tin.', 'audio/mpeg', 'public', 
...
(@bh_li_4_3, 'Short Talks Audio 2 Bài 3','Audio', '20MB', 'Thực hành với các bài nói có tốc độ nhanh và chứa nhiều thông tin.', 'audio/mpeg', 'public', 
...
(@bh_li_4_3, 'Short Talks Audio 3 Bài 3','Audio', '20MB', 'Thực hành với các bài nói có tốc độ nhanh và chứa nhiều thông tin.', 'audio/mpeg', 'public', 
...
-- Bài 1
(@bh_re_1_1, 'Incomplete Sentences Video Bài 1', 'Video', '350MB', 'Ôn tập các chủ điểm ngữ pháp cốt lõi thường gặp trong bài thi (thì, dạng từ, giới từ).', 'video/mp4', 'public', 
...
(@bh_re_1_1, 'Incomplete Sentences PDF Bài 1',   'PDF',   '10MB', 'Ôn tập các chủ điểm ngữ pháp cốt lõi thường gặp trong bài thi (thì, dạng từ, giới từ).', 'application/pdf', 'public', 
...
-- Bài 2
(@bh_re_1_2, 'Incomplete Sentences Video Bài 2', 'Video', '350MB', 'Mở rộng vốn từ vựng theo các chủ đề thương mại, văn phòng và giao dịch.', 'video/mp4', 'public', 
...
(@bh_re_1_2, 'Incomplete Sentences PDF 1 Bài 2',   'PDF',   '10MB', 'Mở rộng vốn từ vựng theo các chủ đề thương mại, văn phòng và giao dịch.', 'application/pdf', 'public', 
...
(@bh_re_1_2, 'Incomplete Sentences PDF 2 Bài 2',   'PDF',   '10MB', 'Mở rộng vốn từ vựng theo các chủ đề thương mại, văn phòng và giao dịch.', 'application/pdf', 'public', 
...
-- Bài 3
(@bh_re_1_3, 'Incomplete Sentences Video Bài 3', 'Video', '350MB', 'Chiến lược đọc và phân tích ngữ cảnh để lựa chọn đáp án đúng cho đoạn văn.', 'video/mp4', 'public', 
...
(@bh_re_1_3, 'Incomplete Sentences PDF Bài 3',   'PDF',   '10MB', 'Chiến lược đọc và phân tích ngữ cảnh để lựa chọn đáp án đúng cho đoạn văn.', 'application/pdf', 'public', 
...
-- Chương 2 - Vocabulary & Reading Comprhension Practice
-- Bài 1
(@bh_re_2_1, 'Vocabulary & Reading Comprhension Practice Video Bài 1', 'Video', '350MB', 'Kỹ năng đọc lướt (skimming) và đọc quét (scanning) để tìm thông tin trong một đoạn văn.', 'video/mp4', 'public', 
...
(@bh_re_2_1, 'Vocabulary & Reading Comprhension Practice PDF Bài 1',   'PDF',   '10MB', 'Kỹ năng đọc lướt (skimming) và đọc quét (scanning) để tìm thông tin trong một đoạn văn.', 'application/pdf', 'public', 
...
-- Bài 2
(@bh_re_2_2, 'Vocabulary & Reading Comprhension Practice Video Bài 2', 'Video', '350MB', 'Hướng dẫn cách liên kết thông tin giữa hai hoặc ba đoạn văn để trả lời câu hỏi.', 'video/mp4', 'public', 
...
(@bh_re_2_2, 'Vocabulary & Reading Comprhension Practice PDF Bài 2',   'PDF',   '10MB', 'Hướng dẫn cách liên kết thông tin giữa hai hoặc ba đoạn văn để trả lời câu hỏi.', 'application/pdf', 'public', 
...
-- Bài 3
(@bh_re_2_3, 'Vocabulary & Reading Comprhension Practice Video Bài 3', 'Video', '350MB', 'Chiến lược quản lý thời gian hiệu quả và xử lý các câu hỏi về từ vựng và suy luận.', 'video/mp4', 'public', 
...
(@bh_re_2_3, 'Vocabulary & Reading Comprhension Practice PDF Bài 3',   'PDF',   '10MB', 'Chiến lược quản lý thời gian hiệu quả và xử lý các câu hỏi về từ vựng và suy luận.', 'application/pdf', 'public', 
