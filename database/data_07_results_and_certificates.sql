...
('COURSE', NULL, NULL, 'OCC Orbit Gradient', 'Hiệu ứng quỹ đạo và điểm nhấn cam nhẹ, thích hợp cho chứng chỉ kỹ năng.', '{"primary":"#1e3a8a","primaryDark":"#0f172a","accent":"#f97316","text":"#0b1220","muted":"#475569"}', 'Assets/Images/certificate-watermark-orbit.svg', @admin_id, 'ACTIVE'),
('COURSE', NULL, NULL, 'OCC Ribbon Contrast', 'Ribbons tương phản, nổi bật logo và mã chứng chỉ.', '{"primary":"#0f172a","primaryDark":"#111827","accent":"#f59e0b","text":"#0f172a","muted":"#6b7280"}', 'Assets/Images/certificate-watermark-ribbon.svg', @admin_id, 'ACTIVE')
