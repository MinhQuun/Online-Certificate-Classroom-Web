...
@section('content')
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
        <div>
            ...
            <h1 class="title mb-0">Quản lý bài giảng</h1>
            <p class="muted mb-0">Tổ chức nội dung, tài liệu và bài tập cho học viên trong khóa học của bạn.</p>
        </div>
        @if($activeCourse)
            <button class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#createLessonModal"
                data-course="{{ $activeCourse->maKH }}"
                data-chapter="{{ $activeCourse->chapters->first()->maChuong ?? '' }}">
            ...
            <div class="card-body d-flex flex-wrap align-items-center gap-3">
                <div class="flex-grow-1">
                    ...
                    <div class="d-flex flex-wrap gap-3 align-items-center">
                        ...
                        <span class="badge bg-light text-dark border">
                            <i class="bi bi-journal-text me-1"></i> {{ number_format($activeCourse?->chapters->count() ?? 0) }} chương
                        </span>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                                    ...
                                                    <div class="d-flex flex-wrap gap-2">
                                                        ...
                                                        <form action="{{ route('teacher.lectures.destroy', $lesson) }}" method="POST"
                                                            onsubmit="return confirm('Xóa bài giảng này?');">
                                                            @csrf
                                                            @method('DELETE')
