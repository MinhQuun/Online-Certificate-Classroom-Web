                ...
                <div class="checkout-stages">
                    ...
                    <div class="checkout-stage {{ $stage === 1 ? 'is-active' : '' }}" data-stage="1">
                        <div class="checkout-card">
                            ...
                            <div class="checkout-actions">
                                ...
                                <a class="btn btn--ghost btn--lg" href="{{ route('student.cart.index') }}">Quay lại giỏ hàng</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="checkout-stage {{ $stage === 2 ? 'is-active' : '' }}" data-stage="2">
                        <div class="checkout-card">
                            ...
                            <form method="post" action="{{ route('student.checkout.complete') }}" class="checkout-payment">
                                @csrf
                                ...
                                <div class="checkout-actions checkout-actions--between">
