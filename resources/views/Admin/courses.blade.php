            ...
            <form class="modal-content" action="{{ route('admin.courses.store') }}" method="post" enctype="multipart/form-data" data-slug-form>
                ...
                <div class="modal-body row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="c_duration" type="number" name="thoiHanNgay" class="form-control" value="{{ old('thoiHanNgay') }}" readonly>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Ngày bắt đầu</label>
                        <input id="c_start" type="date" name="ngayBatDau" class="form-control" value="{{ old('ngayBatDau') }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Ngày kết thúc</label>
                        <input id="c_end" type="date" name="ngayKetThuc" class="form-control" value="{{ old('ngayKetThuc') }}">
                    </div>
                    <div class="col-12">
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <form id="formEdit" class="modal-content" method="post" enctype="multipart/form-data" data-slug-form>
                ...
                <div class="modal-body row g-3">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Thời hạn (ngày) <span class="text-danger">*</span></label>
                        <input id="e_duration" type="number" name="thoiHanNgay" class="form-control" readonly>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Ngày bắt đầu</label>
